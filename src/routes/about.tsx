    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="mx-auto max-w-2xl px-6 py-16 w-full flex-1">
        ...
        <div className="prose-article mt-6">
          ...
          <p>We don't review everything. We review the things that stick — the slow burns, the political thrillers, the documentaries that change how you think about a case. Every piece comes with a rating, a streamer, and an honest take on whether it's worth your evening.</p>
