      ...
      <main className="mx-auto max-w-3xl px-6 py-12 w-full flex-1">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Rating (1–5)"><input type="number" min={1} max={5} className="w-full border border-foreground bg-background p-3" value={form.rating ?? ""} onChange={(e) => setForm({ ...form, rating: e.target.value ? Number(e.target.value) : null })} /></Field>
          </div>
